...
const Search = () => {
    ...
    return (
        <Box>
            ...
            <Stack direction="row" sx={{ width: { md: "65%", mds: "100%" }, margin: "0 auto", my: "3em", alignItems: "center", flexWrap: { sm: "unset", xs: "wrap" } }}>
                ...
                <Stack direction="row" sx={{ justifyContent: { sm: "right", xs: "left" }, flex: { sm: 1, xs: "0 0 100%" }, flexWrap: { sms: "unset", xs: "wrap" } }}>
                    <Stack direction="row" sx={{ alignItems: "center", flex: { sms: "unset", xs: "0 0 100%" } }}>
